...
('Harry Poter và Phòng chứa Bí mật', 1998,002),
...
SELECT * 
FROM Sach 
WHERE TenSach = 'Harry Potter và Hòn đá Phù thủy' or 'Harry Potter và Phòng chứa Bí mật';

SELECT * 
FROM Sach 
WHERE MaTacGia = 0001 and NamXuatBan > 2000;